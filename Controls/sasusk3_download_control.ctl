...
Begin VB.UserControl download_control 
   ...
   Picture         =   "sasusk3_download_control.ctx":0000
   ScaleHeight     =   510
   ScaleWidth      =   480
   ToolboxBitmap   =   "sasusk3_download_control.ctx":08CA
...
Dim dl As New sasusk3_download_class, iWaitDownloadFinish As Boolean
...
Function Sobre()
MsgBox Replace("sasusk3 download control 1.0.0\nControle criador por sasusk3 aka gs1lv4\n(c) Copyright 2008", "\n", vbCrLf), vbInformation + vbOKOnly, "Sobre o sasusk3 download control"
End Function

Function About()
MsgBox Replace("sasusk3 download control 1.0.0\nControl done by sasusk3 aka gs1lv4\n(c) Copyright 2008", "\n", vbCrLf), vbInformation + vbOKOnly, "About sasusk3 download control"
End Function
